...
epochs1, train_losses1, valid_epochs_loss1, valid_losses1, valid_epochs1, valid_metrics1 = extract_data_from_file("/Users/karanthakkar/Downloads/training_log_2023-11-04_13:51:22.txt")
...
plt.plot(epochs1, train_losses1, '-o', label="Train Loss (lr=3e-4)", markersize=3)
...
plt.savefig("train_loss_overlayed.png")

# Continue with other plots...

# Plot Valid Loss
plt.figure(figsize=(12, 6))
plt.plot(valid_epochs_loss1, valid_losses1, '-o', color="red", label="Valid Loss (lr=3e-4)", markersize=3)
...
plt.legend()
plt.grid(True)
plt.savefig("valid_loss_overlayed.png")

# Plot Validation Metric
plt.figure(figsize=(12, 6))
plt.plot(valid_epochs1, valid_metrics1, '-o', color="green", label="Validation Metric (lr=3e-4)", markersize=3)
...
plt.legend()
plt.grid(True)
plt.savefig("validation_metric_overlayed.png")
